...
$databases = array (
  ...
  array (
    'default' => 
    array (
      'database' => 'drupal_pt_projects_sol_ict_org',
      'username' => 'drupal-pt.projec',
      'password' => 'NFWYh8ItZ6fUnon',
      'host' => 'localhost',
      'port' => '',
      'driver' => 'mysql',
      'prefix' => 'dpl_',
 ...
 *
 */
$drupal_hash_salt = '_6bVDlqj4C-pQtlRsNTQkVmjQxla_NIuuXjZZDH2Gi8';
...
$conf['cache_lifetime'] 				= 0;		// Minimum life time (0-... seconds, 900s = 15m)
$conf['page_cache_maximum_age'] 		= 1800;		// Maximum life time (0-... seconds, 3600s = 1h)
$conf['page_compression'] 				= FALSE;		// Page compression (TRUE, FALSE)
$conf['preprocess_css'] 				= FALSE;		// Agregate CSS (TRUE, FALSE)
$conf['preprocess_js'] 					= FALSE;		// Agregate JavaScript (TRUE, FALSE)
}
...
$conf['memcache_storage_key_prefix'] = 'drupal_pt_org';					// Key prefix (mysite)
$conf['memcache_storage_wildcard_invalidate'] = 60 * 60 * 24 * 7;		// Wildcard expiration (60 * 60 * 24 * 7 = 7 days)
...
$conf['memcache_storage_persistent_connection'] = TRUE;					// Persistent connection (TRUE, FALSE)
/* backend configuration */
$conf['memcache_extension'] = 'Memcached';								// Interface (Memcache, Memcached)
...
/* backend cache classes */
$conf['memcache_bins'] = array('cache' => 'default');
/* drupal cache classes */
$conf['cache_default_class'] 			= 'MemcacheStorage';			// Default cache backend (MemcacheStorage)
}

/**
 * Cache: Redis
 */
if (CACHE_BACKEND_REDIS) {
/* drupal backends */
$conf['cache_backends'][] = 'sites/all/modules/contrib/redis/redis.autoload.inc';
$conf['lock_inc'] = 'sites/all/modules/contrib/redis/redis.lock.inc';
/* module configuration */
/* backend configuration */
$conf['redis_client_interface'] = 'PhpRedis';							// Interface (PhpRedis, Predis, ...)
$conf['redis_client_base'] = 0;											// Database number (0-...)
$conf['redis_client_password'] = '';									// Database password (mypassword)
/* backend hosts */
$conf['redis_client_host'] = 'localhost';
$conf['redis_client_port'] = 6379;
/* backend cache classes */
$conf['cache_prefix'] = array('default' => 'drupal_pt_org');
/* drupal cache classes */
$conf['cache_default_class'] 			= 'Redis_Cache';				// Default cache backend (Redis_Cache)
}
